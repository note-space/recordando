...
save_note() ;
set_note_opt($_POST['grid_num'],'has_subgrid',0) ;
$_POST['grid_num'] = 1 ;
grid_screen() ;
}
...
echo "<div id='menu_div' style='display: none; text-align: left; background-color: #EEEEEE' ><br><br>" ;
